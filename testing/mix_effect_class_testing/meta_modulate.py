...
#WE must also run over all numerical values in the class and make sure they are using floats - using integers causes effect/time offsets due to rounding problems
class MetaModulate():
    """
    ...
    def modulate(self):
        ...
        #BUILD OUT EFFECT DATA SCHEMA VALIDATION TO ENSURE START < TARGET AND ALL PARAMETERS ARE PRESENT
