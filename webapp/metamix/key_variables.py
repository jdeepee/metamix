...
modulation_algorithm_parameters = [
	{
		...
		"database_defaults": {"strength_curve_decay": "strength_curve", "strength_curve_delay": "strength_curve_2", 
							  ...
							  "start_decay": "effect_start", "start_delay": "effect_start_2"},
		"defaults": {},
	...
	},
	{
		...
		"defaults": {"strength_curve": "strength_curve", "target": "target", "start": "start"},
	...
	},
	{
		...
		"defaults": {"upper_bound": 15000, "lower_bound": 20, "strength_curve": "strength_curve", "target": "target", "start": "start"},
		"increment_time_change": 5
	},
	{
		"name": "low_pass_filter",
		"parameters": ["strength_curve", "target", "start", "upper_bound", "lower_bound"],
		"defaults": {"upper_bound": 20, "lower_bound": 15000, "strength_curve": "strength_curve", "target": "target", "start": "start"},
		"increment_time_change": 5
	}
]